...
TRAIN_SIZE      = 335       # Puntos base en cada ventana de entrenamiento
VAL_SIZE        = 30        # Puntos base en cada ventana de validacion

# Parametros de Datos
SEQ_LEN         = 62        # Longitud de ventana (dias de historia)
...
def main():
    ...
    #Listas para guardar accuracy y precision de cada fold
    accs = []
    precisions = []
    ...
    for i, (tr_s, tr_e, va_s, va_e) in enumerate(splits, start=1):
        ...
        with torch.no_grad():
            for xb, yb in val_loader:
                ...
                val_labels_batches.append(yb.cpu().numpy())

...
def main():
    ...
    parser.add_argument("--input", default="data/val_predictions.csv", 
                       help="CSV con columnas prob,label (de training.py) o pred_prob,prediccion (de predict.py)")
    parser.add_argument("--output", default="data/roc_curve.png", help="Ruta de salida para la imagen PNG")

...
INPUT_FILE      = 'src/modelo/data/data_test.csv'       # Archivo con datos para predecir
TRAIN_FILE      = 'src/modelo/data/data_train.csv'      # Archivo con datos para entrenar

MODEL_PATH      = 'src/modelo/data/final_model_state.pth' # Checkpoint del modelo entrenado
OUTPUT_FILE     = 'src/modelo/data/predictions.csv'      # Donde guardar el resultado

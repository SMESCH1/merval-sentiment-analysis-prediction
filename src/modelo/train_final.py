...
MODEL_SAVE_PATH = 'src/modelo/data/final_model_state.pth'
LOSS_PLOT_PATH  = 'src/modelo/data/loss_curve_final.png'
...
def main():
    ...
    Path(LOSS_PLOT_PATH).parent.mkdir(parents=True, exist_ok=True)
